...
interleaved:
        model.interleaved ?? (provider.id.includes("deepseek") ? { field: "reasoning_content" } : false), // kilocode_change
    },
...
interleaved:
        model.interleaved ?? ((provider.id ?? providerID).includes("deepseek") ? { field: "reasoning_content" } : false), // kilocode_change
              },
              cost: {
